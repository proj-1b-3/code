namespace App
{
	...
	class Server
	{
		...
		public Server()
		{
			...
			DataBase.Tables.AddRange(new DataTable[]{userTable, productTable, roomAttributeTable,
				reservationTable, consumableAttributeTable,consumableItemTable, reviewTable});
